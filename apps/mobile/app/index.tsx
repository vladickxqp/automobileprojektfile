...
import { ChevronRightIcon, LogoutIcon, PlusIcon } from "../src/ui/icons";
    ...
    <Screen flush>
      <Stack.Screen
        options={{
          ...
          headerLeft: () => (
            <IconButton variant="ghost" accessibilityLabel="Abmelden" onPress={() => void signOut()}>
          ...
          <View style={styles.headerWrap}>
            <Card elevated style={styles.hero}>
              <View style={styles.heroTop}>
                <View>
                  <Text style={styles.heroLabel}>AutoLife</Text>
